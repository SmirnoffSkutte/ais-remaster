...
@section('content')
    @component('common-components.breadcrumb')
        ...
        @slot('title') Профиль (в разработке) @endslot
    @endcomponent
                            ...
                            <div data-simplebar style="max-height: 430px;">
                                <div class="d-flex align-items-start border-bottom py-4">
                                    <img class="me-2 rounded-circle avatar-xs"
                                         src="{{ asset('images/users/avatar-3.jpg') }}" alt="">
                                    <div class="flex-1">
                                        ...
                                        <div class="d-flex align-items-start mt-4">
                                            <img class="me-2 rounded-circle avatar-xs"
                                                 src="{{ asset('images/users/avatar-4.jpg') }}" alt="">
                                            <div class="flex-1">
                                ...
                                <div class="d-flex align-items-start border-bottom py-4">
                                    <img class="me-2 rounded-circle avatar-xs"
                                         src="{{ asset('images/users/avatar-5.jpg') }}" alt="">
                                    <div class="flex-1">
                                ...
                                <div class="d-flex align-items-start border-bottom py-4">
                                    <img class="me-2 rounded-circle avatar-xs"
                                         src="{{ asset('images/users/avatar-7.jpg') }}" alt="">
                                    <div class="flex-1">
