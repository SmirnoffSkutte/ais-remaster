...
@section('css')
    <!-- plugin css -->
    <link href="{{ asset('libs/bootstrap-editable/bootstrap-editable.min.css') }}" rel="stylesheet"
        type="text/css" />
@endsection
...
@section('script')
    <!-- Plugins js -->
    <script src="{{ asset('libs/bootstrap-editable/bootstrap-editable.min.js') }}"></script>
