...
@section('css')
    <!-- DataTables -->
    <link href="{{ asset('libs/bootstrap-touchspin/bootstrap-touchspin.min.css')}}" rel="stylesheet" type="text/css" />
@endsection
    ...
    <div class="col-xl-8">
        <div class="card border shadow-none">
            <div class="card-body">
                ...
                <div class="d-flex align-items-start border-bottom pb-3">
                    <div class="me-4">
                        <img src="{{ asset('images/product/img-1.png')}}" alt="" class="avatar-lg">
                    </div>
        ...
        <div class="card border shadow-none">
            <div class="card-body">
                ...
                <div class="d-flex align-items-start border-bottom pb-3">
                    <div class="me-4">
                        <img src="{{ asset('images/product/img-2.png')}}" alt="" class="avatar-lg">
                    </div>
                    <div class="flex-1 align-self-center overflow-hidden">
                        <div>
...
@section('script')
    ...
    <script src="{{ asset('js/pages/ecommerce-cart.init.js')}}"></script>
@endsection
