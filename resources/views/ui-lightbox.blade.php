...
@section('css')
    <!-- Lightbox css -->
    <link href="{{ asset('libs/magnific-popup/magnific-popup.min.css') }}" rel="stylesheet" type="text/css" />
@endsection
                        ...
                        <div class="col-6">
                            <div>
                                ...
                                <a class="image-popup-vertical-fit"
                                    href="{{ asset('images/small/img-2.jpg') }}"
                                    title="Caption. Can be aligned it to any side and contain any HTML.">
                                    <img class="img-fluid" alt="" src="{{ asset('images/small/img-2.jpg') }}"
                                        width="145">
                                </a>
                            </div>
                        </div>
                        <div class="col-6">
                            <div>
                                ...
                                <a class="image-popup-no-margins"
                                    href="{{ asset('images/small/img-3.jpg') }}">
                                    <img class="img-fluid" alt="" src="{{ asset('images/small/img-3.jpg') }}"
                                        width="75">
                                </a>
                    ...
                    <div class="popup-gallery">
                        <div class="row">
                            <div class="col-xl-2 col-md-4 col-6">
                                <div class="mt-4">
                                    <a href="{{ asset('images/small/img-1.jpg') }}" title="Project 1">
                                        <div class="img-fluid">
                                            <img src="{{ asset('images/small/img-1.jpg') }}" alt=""
                            ...
                            <div class="col-xl-2 col-md-4 col-6">
                                <div class="mt-4">
                                    <a href="{{ asset('images/small/img-2.jpg') }}" title="Project 2">
                                        <div class="img-fluid">
                            ...
                            <div class="col-xl-2 col-md-4 col-6">
                                <div class="mt-4">
                                    <a href="{{ asset('images/small/img-3.jpg') }}" title="Project 3">
                                        <div class="img-fluid">
                                            <img src="{{ asset('images/small/img-3.jpg') }}" alt=""
                                                class="img-fluid d-block">
                                        </div>
                                    </a>
                                </div>
                            ...
                            <div class="col-xl-2 col-md-4 col-6">
                                <div class="mt-4">
                                    <a href="{{ asset('images/small/img-4.jpg') }}" title="Project 4">
                                        <div class="img-fluid">
                            ...
                            <div class="col-xl-2 col-md-4 col-6">
                                <div class="mt-4">
                                    <a href="{{ asset('images/small/img-5.jpg') }}" title="Project 5">
                                        <div class="img-fluid">
                                            <img src="{{ asset('images/small/img-5.jpg') }}" alt=""
                                                class="img-fluid d-block">
                                        </div>
                                    </a>
                                </div>
                            ...
                            <div class="col-xl-2 col-md-4 col-6">
                                <div class="mt-4">
                                    <a href="{{ asset('images/small/img-6.jpg') }}" title="Project 6">
                                        <div class="img-fluid">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="zoom-gallery">
                        <a class="float-start" href="{{ asset('images/small/img-3.jpg') }}"
                            title="Project 1"><img src="{{ asset('images/small/img-3.jpg') }}" alt=""
                                width="275"></a>
                        <a class="float-start" href="{{ asset('images/small/img-7.jpg') }}"
                            title="Project 2"><img src="{{ asset('images/small/img-7.jpg') }}" alt=""
                                width="275"></a>
                    </div>
                </div>
            </div>
...
@section('script')
    <!-- Magnific Popup-->
    <script src="{{ asset('libs/magnific-popup/magnific-popup.min.js') }}"></script>
    <!-- lightbox init js-->
