...
@section('css')
    <!-- leaflet Css -->
    <link href="{{ asset('libs/leaflet/leaflet.min.css') }}" rel="stylesheet" type="text/css" />
@endsection
...
@section('script')
    ...
    <!-- leaflet map.init -->
    <script src="{{ asset('js/pages/leaflet-us-states.js') }}"></script>
    <script src="{{ asset('js/pages/leaflet-map.init.js') }}"></script>
@endsection
