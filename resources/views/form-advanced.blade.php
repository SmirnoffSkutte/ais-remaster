...
@section('css')
    ...
    <link href="{{ asset('libs/spectrum-colorpicker/spectrum-colorpicker.min.css') }}" rel="stylesheet">
...
@section('script')
    ...
    <script src="{{ asset('libs/spectrum-colorpicker/spectrum-colorpicker.min.js') }}"></script>
