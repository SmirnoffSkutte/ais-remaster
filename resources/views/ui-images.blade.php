                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <img class="rounded mr-2" alt="200x200" width="200"
                                src="{{ asset('images/small/img-4.jpg') }}" data-holder-rendered="true">
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <img class="img-thumbnail" alt="200x200" width="200"
                                src="{{ asset('images/small/img-3.jpg') }}" data-holder-rendered="true">
                        </div>
                        <div class="col-md-6">
                            <div class="mt-4 mt-md-0">
        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="">
                        <img src="{{ asset('images/small/img-2.jpg') }}" class="img-fluid"
