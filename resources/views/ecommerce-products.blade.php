...
@endsection
@section('css')
    <link href="{{ asset('libs/ion-rangeslider/ion-rangeslider.min.css') }}" rel="stylesheet"
        type="text/css" />
@endsection
                            ...
                            <div class="col-xl-4 col-sm-6">
                                <div class="product-box">
                                    <div class="product-img pt-4 px-4">
                                        ...
                                        <img src="{{ asset('images/product/img-5.png') }}" alt=""
                                            class="img-fluid mx-auto d-block">
                                    </div>
...
@endsection
@section('script')
    <script src="{{ asset('libs/ion-rangeslider/ion-rangeslider.min.js') }}"></script>
