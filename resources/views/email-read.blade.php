        ...
        <div class="col-12">
            ...
            <div class="email-leftbar card">
                ...
                <div class="mt-2">
                    ...
                    <a href="#" class="d-flex align-items-start">
                        <img class="d-flex me-3 rounded-circle"
                            src="{{ asset('images/users/avatar-3.jpg') }}" alt="Generic placeholder image"
                            height="36">
                        <div class="flex-1 chat-user-box overflow-hidden">
                    ...
                    <a href="#" class="d-flex align-items-start">
                        <img class="d-flex me-3 rounded-circle"
                            src="{{ asset('images/users/avatar-4.jpg') }}" alt="Generic placeholder image"
                            height="36">
                        <div class="flex-1 chat-user-box overflow-hidden">
                    ...
                    <a href="#" class="d-flex align-items-start">
                        <img class="d-flex me-3 rounded-circle"
                            src="{{ asset('images/users/avatar-6.jpg') }}" alt="Generic placeholder image"
                            height="36">
                        <div class="flex-1 chat-user-box overflow-hidden">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-xl-2 col-6">
                                <div class="card border shadow-none">
                                    <img class="card-img-top img-fluid"
                                        src="{{ asset('images/small/img-3.jpg') }}" alt="Card image cap">
                            ...
                            <div class="col-xl-2 col-6">
                                <div class="card border shadow-none">
                                    <img class="card-img-top img-fluid"
                                        src="{{ asset('images/small/img-4.jpg') }}" alt="Card image cap">
                                    <div class="py-2 text-center">
                                        <a href="" class="fw-medium">Download</a>
                                    </div>
                                </div>
...
@section('script')
    ...
    <script src="{{ asset('js/pages/email-editor.init.js') }}"></script>
@endsection
