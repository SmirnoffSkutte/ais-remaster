...
@section('css')
    ...
    <link href="{{ asset('libs/jquery-bar-rating/jquery-bar-rating.min.css') }}" rel="stylesheet"
        type="text/css" />
@endsection
...
@section('script')
    <!-- Sweet Alerts js -->
    <script src="{{ asset('libs/jquery-bar-rating/jquery-bar-rating.min.js') }}"></script>
