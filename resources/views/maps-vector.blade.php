...
@endsection
@section('css')
    <link href="{{ asset('libs/jquery-vectormap/jquery-vectormap.min.css') }}" rel="stylesheet"
        type="text/css" />
@endsection
...
@section('script')
    <!-- Plugins js-->
    <script src="{{ asset('libs/jquery-vectormap/jquery-vectormap.min.js') }}"></script>
    <!-- Init js-->
    <script src="{{ asset('js/pages/vector-maps.init.js') }}"></script>
@endsection
